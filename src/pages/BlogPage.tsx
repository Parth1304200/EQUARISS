      ...
      <div className="mx-auto max-w-3xl px-6 py-16 md:py-24">
        <div className="flex flex-col gap-4 mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground">
            Insights, updates, and financial tips.
          </p>
        </div>

        {/* CONTENT BODY */}
        <div className="flex flex-col gap-4 text-muted-foreground leading-relaxed text-lg">
          {`Welcome to our blog. While we are currently drafting our first official posts, this space will soon be home to updates about new features, tips on managing group finances, and stories from our community.`.split('\\n').map((line, i) => (

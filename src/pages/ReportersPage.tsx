    ...
    <div className="min-h-screen bg-background text-foreground relative font-sans">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 md:py-24">
        ...
        <div className="flex flex-col gap-4 text-muted-foreground leading-relaxed text-lg">
          {`If you are a security researcher and have found a vulnerability in Equaris, please report it to us at **splitequaris@gmail.com**. We take all reports seriously and will work to patch any legitimate issues immediately.`.split('\\n').map((line, i) => (

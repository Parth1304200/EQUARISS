    ...
    <div className="min-h-screen bg-background text-foreground relative font-sans">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 md:py-24">
        ...
        <div className="flex flex-col gap-4 text-muted-foreground leading-relaxed text-lg">
          {`We're always looking for talented engineers, designers, and thinkers to help us build Equaris. Though we have no open roles at this exact moment, feel free to send your resume to our contact email to be considered for future opportunities.`.split('\\n').map((line, i) => (

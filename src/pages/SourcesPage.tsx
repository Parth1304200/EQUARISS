    ...
    <div className="min-h-screen bg-background text-foreground relative font-sans">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 md:py-24">
        ...
        <div className="flex flex-col gap-4 text-muted-foreground leading-relaxed text-lg">
          {`Equaris relies on numerous open-source libraries and frameworks. We are committed to maintaining a transparent tech stack and contributing back to the developer community when possible. Our key technologies include React, Vite, Tailwind CSS, and Firebase.`.split('\\n').map((line, i) => (
